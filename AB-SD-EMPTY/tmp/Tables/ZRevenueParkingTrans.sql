CREATE TABLE [tmp].[ZRevenueParkingTrans] (
...
GO
CREATE NONCLUSTERED INDEX [IX_ZRevenueParkingTrans-Search]
    ON [tmp].[ZRevenueParkingTrans]([Time] ASC, [TransactionNo] ASC);
