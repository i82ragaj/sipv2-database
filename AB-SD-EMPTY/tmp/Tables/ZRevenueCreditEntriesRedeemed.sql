CREATE TABLE [tmp].[ZRevenueCreditEntriesRedeemed] (
...
GO
CREATE NONCLUSTERED INDEX [IX_ZRevenueCreditEntriesRedeemed-Time]
    ON [tmp].[ZRevenueCreditEntriesRedeemed]([Time] ASC);
